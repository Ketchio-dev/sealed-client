...
import dev.sealedclient.v26.mixin.visual.RenderSetupAccessor26;
import dev.sealedclient.v26.mixin.visual.RenderSetupInvoker26;
import dev.sealedclient.v26.mixin.visual.RenderTypeAccessor26;
import dev.sealedclient.v26.mixin.visual.RenderTypeInvoker26;
            ...
            try {
                RenderSetup originalSetup =
                        ((RenderTypeAccessor26) (Object) original)
                                .sealedclient$getState();
                RenderSetupAccessor26 setup =
                        (RenderSetupAccessor26) (Object) originalSetup;
                RenderPipeline pipeline = createThroughWallPipeline(
                        setup.sealedclient$getPipeline()
                );
                @SuppressWarnings("rawtypes")
                Map textures = setup.sealedclient$getTextures();
                RenderSetup transformedSetup =
                        RenderSetupInvoker26.sealedclient$create(
                                pipeline,
                                textures,
                                setup.sealedclient$getUseLightmap(),
                                setup.sealedclient$getUseOverlay(),
                                setup.sealedclient$getLayeringTransform(),
                                setup.sealedclient$getOutputTarget(),
                                setup.sealedclient$getTextureTransform(),
                                setup.sealedclient$getOutlineProperty(),
                                setup.sealedclient$getAffectsCrumbling(),
                                setup.sealedclient$getSortOnUpload()
                        );
                RenderType transformed =
                        RenderTypeInvoker26.sealedclient$create(
                                "sealed_chams_"
