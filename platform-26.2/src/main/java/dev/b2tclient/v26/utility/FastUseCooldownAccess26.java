...
import dev.b2tclient.v26.mixin.utility.MinecraftRightClickDelayAccessor26;
...
final class FastUseCooldownAccess26 {
    ...
    static int current(Minecraft client) {
        ...
        try {
            return accessor.b2t$rightClickDelay();
    ...
    private static boolean write(Minecraft client, int delayTicks) {
        ...
        try {
            accessor.b2t$setRightClickDelay(delayTicks);
            return true;
        } catch (RuntimeException | LinkageError ignored) {
            return false;
        }
