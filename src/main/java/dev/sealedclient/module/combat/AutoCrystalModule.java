...
import dev.sealedclient.api.SealedApi;
import dev.sealedclient.combat.CombatTransactionEngine;
import dev.sealedclient.combat.CombatUtil;
import dev.sealedclient.combat.CrystalScoring;
import dev.sealedclient.combat.ExplosionDamageEstimator;
...
public final class AutoCrystalModule extends Module implements TickableModule {
    ...
    protected void onEnable(Minecraft minecraft) {
        ...
        if (SealedClient.isInitialized()) {
            packetSubscription = SealedApi.events().subscribe(
                    PacketEvent.class,
                    50,
                    this::onPacket
            );
