...
final class B2TMovementSupport {
    ...
    static MovementSafetyController.Observation safetyObservation(Minecraft minecraft) {
        ...
        MovementNetworkTracker.Snapshot network = B2TClient.isInitialized()
                ? B2TClient.runtime().movementNetwork().snapshot()
